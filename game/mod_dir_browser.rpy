                ...
                viewport id "fe":
                    ...
                    if current_dir is None:
                        for x in drives:
                            hbox:
                                imagebutton:
                                    idle LiveComposite((460, 18), (0, 0), "ddmd_file_physical_drive", (18, 2), Text(x + ":/", substitute=False, size=12, style="pc_dir_text"))
                                    hover LiveComposite((460, 18), (0, 0), Frame("#dbdbdd"), (0, 0), "ddmd_file_physical_drive", (18, 2), Text(x + ":/", substitute=False, size=12, style="pc_dir_text"))
                        ...
                        for x in net_drives:
                            hbox:
                                imagebutton:
                                    idle LiveComposite((460, 18), (0, 0), "ddmd_file_network_drive", (18, 2), Text(x + ":/", substitute=False, size=12, style="pc_dir_text"))
                                    hover LiveComposite((460, 18), (0, 0), Frame("#dbdbdd"), (0, 0), "ddmd_file_network_drive", (18, 2), Text(x + ":/", substitute=False, size=12, style="pc_dir_text"))
                        ...
                        for x in os.listdir(current_dir):
                            if os.path.isdir(os.path.join(current_dir, x)):
                                hbox:
                                    imagebutton:
                                        idle LiveComposite((460, 18), (0, 0), "ddmd_file_folder", (18, 2), Text(x, substitute=False, size=12, style="pc_dir_text"))
                                        hover LiveComposite((460, 18), (0, 0), Frame("#dbdbdd"), (0, 0), "ddmd_file_folder", (18, 2), Text(x, substitute=False, size=14, style="pc_dir_text"))
                                ...
                                hbox:
                                    imagebutton:
                                        idle LiveComposite((460, 18), (0, 0), "ddmd_file_file", (18, 2), Text(x, substitute=False, size=12, style="pc_dir_text"))
                                        hover LiveComposite((460, 18), (0, 0), Frame("#dbdbdd"), (0, 0), "ddmd_file_file", (18, 2), Text(x, substitute=False, size=14, style="pc_dir_text"))
                        ...
                        for x in os.listdir(current_dir):
                            if os.path.isdir(os.path.join(current_dir, x)):
                                hbox:
                                    imagebutton:
                                        idle LiveComposite((460, 18), (0, 0), "ddmd_file_folder", (18, 2), Text(x, substitute=False, size=12, style="pc_dir_text"))
                                        hover LiveComposite((460, 18), (0, 0), Frame("#dbdbdd"), (0, 0), "ddmd_file_folder", (18, 2), Text(x, substitute=False, size=12, style="pc_dir_text"))
